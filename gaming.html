  ...
  <body>
    ...
    <script>
      ...
      function initMap() {
        ...
        // TODO: Make default address field automatically the center of returned results
        geocoder.geocode({ address: "Ellensburg" }, function(results, status) {
          if (status == google.maps.GeocoderStatus.OK) {
            ...
            makeCategoryRequest('gaming', './backend/getEventsByCategory.php', function(data) {
              // Debug Message
    ...
    <script src="scriptFiles/gamingScript.js"></script>
