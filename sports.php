  ...
  <body>
    ...
    <script>
      ...
      function initMap() {
        ...
        // TODO: Make default address center of returned events
        geocoder.geocode( { 'address': "Ellensburg"}, function(results, status) {
          if (status == google.maps.GeocoderStatus.OK) {
            ...
            makeCategoryRequest('sports', './backend/getEventsByCategory.php', function(data) {
              // Debug Message
    ...
    <script src="scriptFiles/sportsScript.js"></script>
